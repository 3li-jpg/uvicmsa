...
export function Button({ className, href, variant = 'primary', children, ...props }: ButtonProps) {
  const styles = cn(
    'inline-flex min-h-11 touch-manipulation items-center justify-center rounded-full px-6 py-3 text-sm font-medium tracking-[0.01em] transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-forest focus-visible:ring-offset-2 focus-visible:ring-offset-ivory dark:focus-visible:ring-offset-[#101a2a]',
    variant === 'primary'
