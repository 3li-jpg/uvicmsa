        ...
        return (
          ...
          >
            ...
            >
              ...
              <ChevronDown
                className={cn('h-5 w-5 flex-none text-deep/70 transition-transform duration-300', isOpen && 'rotate-180')}
              />
            </button>
            <div
              ...
              role="region"
            >
              <div className="overflow-hidden pr-10 text-sm leading-7 text-body/80 sm:text-base">{item.answer}</div>
            </div>
          </div>
        )
      })}
