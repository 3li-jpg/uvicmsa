          ...
          <div className="mt-12 grid gap-5 lg:grid-cols-3">
            {posts.map((post) => (
              <a href={post.link} key={post.id} rel="noreferrer" target="_blank">
                <Card className="group h-full overflow-hidden p-3 hover:-translate-y-1 hover:bg-white/72">
                  ...
                  <div className="p-3 pb-2 pt-5 sm:px-4">
                    <p className="line-clamp-3 text-sm leading-7 text-body/80">{trimCaption(post.caption)}</p>
                    <div className="mt-4 inline-flex items-center gap-2 text-sm font-medium text-deep transition-colors duration-300 group-hover:text-forest">
                      View post
          ...
          <Card className="mt-12 p-6 sm:p-8">
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <a
                  className="mt-6 inline-flex items-center gap-2 text-sm font-medium text-deep transition-colors duration-300 hover:text-forest"
